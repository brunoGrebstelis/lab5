...
/**
 * The main task for this class is to print out selected information
 * @author bruno
 *
 */
...
public class PrintOut {
	...
	PrintOut(LinkedHashMap<Integer, Person> showPersons2){
	...
	public void print_ascending() {
		for (Entry<Integer, Person> m : showPersons2.entrySet()) {
			Person a = m.getValue();
			System.out.println(
					"Element nr." + m.getKey() + ") " + a.getName() + "; " + a.FgetBirthday() + "; " + a.getEyeColor()+"; ID-"+a.getID());
